...
image1 = CurrentFolder+'\\img.png'
"""image2=CurrentFolder+'\\img2.jpg'"""
  #Add Student images
...
#Load more pictures of students


# Create arrays of known face encodings and their names
known_face_encodings = [
    person1_face_encoding#,     #place comma to add more
    #person2_face_encoding              #add more with comma at the end of each line
    
    #Add more students encodings
]
known_face_names = [
    person1_name#,   add comma to add more students names
    #Add more students face names
]
